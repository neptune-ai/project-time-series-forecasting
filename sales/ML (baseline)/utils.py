...
def get_data(df_encoded, features_to_exclude=['Weekly_Sales', 'Date']):

    X = df_encoded.loc[:, ~df_encoded.columns.isin(features_to_exclude)]
    y = df_encoded.loc[:, 'Weekly_Sales']
